...
use auto_dev_core::llm::provider::{GenerationOptions, LLMProvider, ProjectContext, Specification};
...
async fn main() -> anyhow::Result<()> {
    ...
    let spec = Specification {
        ...
        requirements: vec![
            "Must check for @ symbol".to_string(),
            "Must check for domain".to_string(),
        ],
        examples: vec![],
