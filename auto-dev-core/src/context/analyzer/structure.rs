...
fn determine_directory_purpose(name: &str, path: &Path, project_root: &Path) -> DirectoryPurpose {
    ...
    if lower_name.contains("test") || lower_name == "tests" || lower_name == "spec" || lower_name == "specs" {
    ...
    } else if lower_name == "build" || lower_name == "dist" || lower_name == "target" || lower_name == "out" {
        DirectoryPurpose::Build
    } else if lower_name == "assets" || lower_name == "static" || lower_name == "public" || lower_name == "resources" {
...
fn determine_file_type(path: &Path, name: &str, extension: &Option<String>) -> FileType {
    ...
    if let Some(ext) = extension {
        match ext.as_str() {
            ...
            "toml" | "yaml" | "yml" | "json" | "ini" | "cfg" | "conf" => return FileType::Configuration,
            "rs" | "py" | "js" | "ts" | "go" | "java" | "c" | "cpp" | "cs" => return FileType::Source,
    ...
    if name == "Cargo.toml" || name == "package.json" || name == "pom.xml" || 
       name == "go.mod" || name == "requirements.txt" {
...
fn is_entry_point(path: &Path) -> bool {
    if let Some(name) = path.file_name().and_then(|n| n.to_str()) {
        ...
        name == "main.py" || name == "__main__.py" || name == "__init__.py" ||
        name == "index.js" || name == "index.ts" || name == "app.js" || name == "app.ts" ||
        name == "main.go" || name == "main.java" || name == "Main.java" ||
        name == "main.c" || name == "main.cpp" || name == "Program.cs"
    } else {
        false
    }
}
