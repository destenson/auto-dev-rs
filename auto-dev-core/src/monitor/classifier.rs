...
impl FileClassifier {
    ...
    pub fn new() -> Self {
        ...
        patterns.insert(FileCategory::Specification, vec![
            Pattern { pattern_type: PatternType::Filename, value: "spec.md".to_string() },
            Pattern { pattern_type: PatternType::Filename, value: "specification.md".to_string() },
            Pattern { pattern_type: PatternType::PathContains, value: "requirements".to_string() },
            Pattern { pattern_type: PatternType::PathContains, value: "design".to_string() },
            Pattern { pattern_type: PatternType::PathContains, value: "architecture".to_string() },
        ...
        patterns.insert(FileCategory::Documentation, vec![
            ...
            Pattern { pattern_type: PatternType::PathContains, value: "documentation".to_string() },
        ...
        // Test patterns
        patterns.insert(FileCategory::Test, vec![
        ...
        patterns.insert(FileCategory::Implementation, vec![
        ...
        patterns.insert(FileCategory::Configuration, vec![
            ...
            Pattern { pattern_type: PatternType::Filename, value: "pyproject.toml".to_string() },
            Pattern { pattern_type: PatternType::Filename, value: "requirements.txt".to_string() },
            Pattern { pattern_type: PatternType::Filename, value: "Dockerfile".to_string() },
            Pattern { pattern_type: PatternType::Filename, value: "docker-compose.yml".to_string() },
        ...
        // Schema patterns
        patterns.insert(FileCategory::Schema, vec![
        ...
        // Example patterns
        patterns.insert(FileCategory::Example, vec![
    ...
    fn matches_pattern(&self, pattern: &Pattern, path: &str, file_name: &str, extension: &str) -> bool {
    ...
    pub fn add_pattern(&mut self, category: FileCategory, pattern_type: PatternType, value: String) {
...
mod tests {
    ...
    fn test_classify_specification() {
        ...
        assert_eq!(classifier.classify(Path::new("requirements/auth.md")), FileCategory::Specification);
        assert_eq!(classifier.classify(Path::new("design/architecture.md")), FileCategory::Specification);
    }
