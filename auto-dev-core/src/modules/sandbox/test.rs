...
mod integration_tests {
    use crate::modules::sandbox::{
        Capability, CapabilitySet, ModuleSandbox,
        capabilities::{FileOperation, FileSystemCapability, NetworkCapability, NetworkProtocol},
    };
    ...
    async fn test_resource_monitoring() {
        use crate::modules::sandbox::resource_limits::{ResourceLimits, ResourceMonitor};
    ...
    async fn test_violation_handling() {
        use crate::modules::sandbox::{
            AuditLogger, ViolationHandler, ViolationType, violations::ViolationResponse,
        };
        use std::sync::Arc;
