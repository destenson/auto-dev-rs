...
mod tests {
    ...
    async fn test_module_discovery() {
        ...
        let mut parser_manifest = manifest::ManifestParser::parse_from_path(&parser_manifest_path).unwrap();
        ...
        let mut gen_manifest = manifest::ManifestParser::parse_from_path(&gen_manifest_path).unwrap();
        ...
        let mut fmt_manifest = manifest::ManifestParser::parse_from_path(&fmt_manifest_path).unwrap();
