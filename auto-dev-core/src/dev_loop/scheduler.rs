...
impl TaskScheduler {
    ...
    pub async fn record_execution(
        ...
        history.push(TaskExecution { task_id, timestamp: Utc::now(), success, duration, error });
...
mod tests {
    ...
    async fn test_task_execution() {
        ...
        let task = ScheduledTask::new("immediate_task".to_string(), Utc::now(), Arc::new(TestTask));
