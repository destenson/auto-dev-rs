...
impl TestFrameworkAdapter for JestAdapter {
    ...
    fn generate_assertion(&self, assertion: &Assertion) -> String {
        match assertion.assertion_type {
            AssertionType::Equals => format!("expect({}).toBe({})", assertion.actual, assertion.expected),
            AssertionType::NotEquals => format!("expect({}).not.toBe({})", assertion.actual, assertion.expected),
            AssertionType::Contains => format!("expect({}).toContain({})", assertion.actual, assertion.expected),
